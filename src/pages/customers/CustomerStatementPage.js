...
const CustomerStatementPage = () => {
    ...
    return (_jsx(LocalizationProvider, { dateAdapter: AdapterDateFns, children: _jsxs(Box, { sx: { p: 2 }, children: [_jsxs(Box, { sx: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }, children: [_jsxs(Box, { sx: { display: 'flex', alignItems: 'center', gap: 2 }, children: [_jsx(IconButton, { onClick: () => navigate(`/customers/${id}`), children: _jsx(BackIcon, {}) }), _jsx(Typography, { variant: "h4", fontWeight: "bold", color: "primary", children: "Customer Statement" })] }), _jsxs(Box, { sx: { display: 'flex', gap: 1 }, children: [_jsx(Button, { variant: "outlined", startIcon: _jsx(ExportIcon, {}), onClick: handleExport, children: "Export CSV" }), _jsx(Button, { variant: "outlined", startIcon: _jsx(PrintIcon, {}), onClick: handlePrint, children: "Print" })] })] }), customer && (_jsx(Paper, { sx: { p: 3, mb: 3 }, children: _jsxs(Grid, { container: true, spacing: 3, children: [_jsxs(Grid, { size: { xs: 12, md: 6 }, children: [_jsx(Typography, { variant: "h6", sx: { mb: 1 }, children: customer.name }), _jsx(Typography, { variant: "body2", color: "text.secondary", children: customer.code }), _jsxs(Typography, { variant: "body2", color: "text.secondary", children: [customer.address, customer.city ? `, ${customer.city}` : ''] }), _jsx(Typography, { variant: "body2", color: "text.secondary", children: customer.phone })] }), _jsxs(Grid, { size: { xs: 12, md: 6 }, sx: { textAlign: { md: 'right' } }, children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: "Statement Period" }), _jsxs(Typography, { variant: "body1", fontWeight: "medium", children: [fromDate ? format(fromDate, 'dd/MM/yyyy') : '', " - ", toDate ? format(toDate, 'dd/MM/yyyy') : ''] })] })] }) })), _jsx(Paper, { sx: { p: 2, mb: 3 }, children: _jsxs(Grid, { container: true, spacing: 2, alignItems: "center", children: [_jsx(Grid, { size: { xs: 12, sm: 4 }, children: _jsx(DatePicker, { label: "From Date", value: fromDate, onChange: setFromDate, slotProps: { textField: { size: 'small', fullWidth: true } } }) }), _jsx(Grid, { size: { xs: 12, sm: 4 }, children: _jsx(DatePicker, { label: "To Date", value: toDate, onChange: setToDate, slotProps: { textField: { size: 'small', fullWidth: true } } }) }), _jsx(Grid, { size: { xs: 12, sm: 4 }, children: _jsx(Button, { variant: "contained", onClick: () => refetch(), fullWidth: true, children: "Generate Statement" }) })] }) }), _jsxs(Paper, { sx: { p: 2 }, children: [_jsxs(Box, { sx: { display: 'flex', justifyContent: 'space-between', mb: 2 }, children: [_jsxs(Box, { children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: "Opening Balance" }), _jsx(Typography, { variant: "h6", fontWeight: "bold", children: formatCurrency(openingBalance) })] }), _jsxs(Box, { sx: { textAlign: 'right' }, children: [_jsx(Typography, { variant: "body2", color: "text.secondary", children: "Closing Balance" }), _jsx(Typography, { variant: "h6", fontWeight: "bold", color: closingBalance > 0 ? 'error' : 'success', children: formatCurrency(closingBalance) })] })] }), _jsx(Divider, { sx: { mb: 2 } }), _jsx(TableContainer, { children: _jsxs(Table, { size: "small", children: [_jsx(TableHead, { children: _jsxs(TableRow, { sx: { backgroundColor: 'primary.main' }, children: [_jsx(TableCell, { sx: { color: 'white' }, children: "Date" }), _jsx(TableCell, { sx: { color: 'white' }, children: "Type" }), _jsx(TableCell, { sx: { color: 'white' }, children: "Reference" }), _jsx(TableCell, { sx: { color: 'white' }, children: "Description" }), _jsx(TableCell, { sx: { color: 'white' }, align: "right", children: "Debit" }), _jsx(TableCell, { sx: { color: 'white' }, align: "right", children: "Credit" }), _jsx(TableCell, { sx: { color: 'white' }, align: "right", children: "Balance" })] }) }), _jsxs(TableBody, { children: [rows.length === 0 && !isLoading && (_jsx(TableRow, { children: _jsx(TableCell, { colSpan: 7, align: "center", sx: { py: 4 }, children: _jsx(Typography, { color: "text.secondary", children: "No transactions for the selected period" }) }) })), rows.map((row, idx) => (_jsxs(TableRow, { hover: true, children: [_jsx(TableCell, { children: format(parseISO(row.date), 'dd/MM/yyyy') }), _jsx(TableCell, { children: _jsx(Chip, { label: row.type, size: "small", color: row.type === 'PAYMENT' || row.type === 'CREDIT_NOTE' ? 'success' : 'default' }) }), _jsx(TableCell, { fontWeight: "medium", children: row.reference }), _jsx(TableCell, { children: row.description }), _jsx(TableCell, { align: "right", sx: { color: row.debit > 0 ? 'error.main' : 'inherit' }, children: row.debit > 0 ? formatCurrency(row.debit) : '-' }), _jsx(TableCell, { align: "right", sx: { color: row.credit > 0 ? 'success.main' : 'inherit' }, children: row.credit > 0 ? formatCurrency(row.credit) : '-' }), _jsx(TableCell, { align: "right", fontWeight: "medium", children: formatCurrency(row.balance) })] }, idx)))] })] }) })] }), _jsx(Box, { sx: { display: 'none' }, children: _jsxs("div", { ref: printRef, children: [_jsxs("div", { className: "header", children: [_jsx("h1", { children: "CUSTOMER STATEMENT" }), _jsxs("p", { children: [fromDate ? format(fromDate, 'dd/MM/yyyy') : '', " - ", toDate ? format(toDate, 'dd/MM/yyyy') : ''] })] }), customer && (_jsxs("div", { className: "customer-info", children: [_jsxs("div", { children: [_jsx("p", { children: _jsx("strong", { children: customer.name }) }), _jsx("p", { children: customer.code }), _jsxs("p", { children: [customer.address, customer.city ? `, ${customer.city}` : ''] }), _jsx("p", { children: customer.phone })] }), _jsxs("div", { style: { textAlign: 'right' }, children: [_jsxs("p", { children: ["Opening Balance: ", formatCurrency(openingBalance)] }), _jsxs("p", { children: ["Closing Balance: ", formatCurrency(closingBalance)] })] })] })), _jsxs("table", { children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "Date" }), _jsx("th", { children: "Type" }), _jsx("th", { children: "Reference" }), _jsx("th", { children: "Description" }), _jsx("th", { children: "Debit" }), _jsx("th", { children: "Credit" }), _jsx("th", { children: "Balance" })] }) }), _jsx("tbody", { children: rows.map((row, idx) => (_jsxs("tr", { children: [_jsx("td", { children: format(parseISO(row.date), 'dd/MM/yyyy') }), _jsx("td", { children: row.type }), _jsx("td", { children: row.reference }), _jsx("td", { children: row.description }), _jsx("td", { className: "debit", children: row.debit > 0 ? formatCurrency(row.debit) : '' }), _jsx("td", { className: "credit", children: row.credit > 0 ? formatCurrency(row.credit) : '' }), _jsx("td", { children: formatCurrency(row.balance) })] }, idx))) })] }), _jsxs("div", { className: "totals", children: [_jsxs("p", { children: ["Opening Balance: ", formatCurrency(openingBalance)] }), _jsxs("p", { children: ["Closing Balance: ", formatCurrency(closingBalance)] })] })] }) })] }) }));
};
